    ...
    <div className='flex flex-col items-center bg-gradient-to-b from-[#001111] to-[#001a1a] w-full  px-3 py-4 relative'>
      ...
      <div className='w-169'>
        <h1 className='text-white font-bold text-5xl text-center leading-16 '>
          All The AI Tools You Need to <span className='text-teal-300'>Improve</span> your Work Flow
        </h1>
      </div>
      <div className='flex px-30 py-25 justify-evenly items-center'>
        ...
        <p className='text-neutral-300 mt-6 leading-10'>Automatically categorize and tag your notes using AI-driven analysis. NoteFlow intelligently identifies key topics and organizes your content, making it easy to find and retrieve your notes when you need them most.</p>
        </div>
      </div>
